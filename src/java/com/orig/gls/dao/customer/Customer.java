...
//    public static void main(String[] args) {
//        verifyAccountDetails("000037026","MARK");
//    }
...
//        ArrayList all = getAccountDetails("37026");
//        int size = all.size();
//
...
//    }
    ...
    public static ArrayList getAccountDetails(String foracid) {
        ...
        for (int h = 0; h < ar.size(); h++) {
            ...
            loanAcc = getlinkedAccounts("GLS%", k);
            operAcc = getlinkedAccounts("SBGCO", k);
            saveAcc = getlinkedAccounts("SBGLS", k);
