...
//foracid,acct_name,acct_mgr_user_id, dis_amt ,dis_shdl_date
    String FORACID,ACCT_NAME,ACCT_MGR_USER_ID, DIS_AMT, DIS_SHDL_DATE, SUB_GROUP_CODE;

    public Disbursement(String FORACID,String ACCT_NAME,String ACCT_MGR_USER_ID, String DIS_AMT, String DIS_SHDL_DATE, String SUB_GROUP_CODE) {
