...
<html>
    <header>
        ...
        <script  type="text/javascript">
            ...
            function getCustUpdateCpValue(id) {
                var rmCode = document.getElementById("rmCode").value;
                var prods = getCheckedProducts(product);
                popup = window.open("updatetrackerprevious.jsp?product=" + prods + "&rmCode=" + rmCode + "&custId=" + id, "Update Customer Information", "width=600,height=600");
                popup.focus();
                return false
            }
    ...
    <center>
        ...
        <form action="updatetracker.jsp" name="form2" id="form2">
            ...
            <center><input type="submit"  name="sell" value="Sell" width="100%" id="sell" onclick="return getCustUpdateCpValue('<%= custId%>')"   style="color:#ffffff;background-color:#24315e;align-self: center;width: 15em;  height: 2em; border-radius: 12px;"></center>
