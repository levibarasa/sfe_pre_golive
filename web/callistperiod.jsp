...
<html>
    <head>
        <title>Previous Weekly Call List Period</title>
    ...
    <script type="text/javascript">
        ...
        function getPrevWklyListValue() {
            var days = window.opener.document.getElementById("days");
            popup = window.open("previousweeklycalllist.jsp?days=" + 7, "Previous Weekly List", "width=1000,height=800");
            popup.focus();
            return false
        }
    </script>
...
<body>
    <form>
        ...
        <select name="days" id="days">
            <option value="7">Select weekly list Period</option>
            <option value="7">Last week</option>
            <option value="14">1 -2 weeks</option> 
            <option value="21">2-3 weeks</option>
            <option value="28">3-4 weeks</option>
            <option value="35">1-2 months</option>
            <option value="42">2 -3 months</option> 
            <option value="49">3-4 months</option> 
        </select>
