...
<h2 style="font: bold 90% 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size: 16px">Customer Mapping Maintenance</h2>
<form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=gomcustomer" onsubmit=" return validatePasswords(this)">
    <table width="70%" border="0" align="left" cellpadding="5" cellspacing="2">
        <tr>
            <th colspan="5" scope="col"><div class="header">&nbsp;Customer Mapping Maintenance</div></th>
        </tr>
        <tr>
