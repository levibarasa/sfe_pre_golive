...
<header>
    ...
    function getExistingCustValue(id) {
        var rmCode = document.getElementById("rmCode").value;
             popup = window.open("addExisting.jsp?custId="+id+"&rmCode="+rmCode, "Customer Information", "width=1000,height=800");
            popup.focus();
            return false
        }
        ...
        System.out.println("CustId:: "+custId);
         String rmCode = request.getParameter("rmCode");
            ...
            if(custId == "" || custId == null ){
             ar = Customer.populateCustomerListByName(rmCode,custName);
            }
            else
            if(custName == "" || custName == null){
            ar = Customer.populateCustomerListById(rmCode,custId);
                }
                else {
            ar = new ArrayList();
                }
                ...
                <table class="zui-table">
                    ...
                    <tr style="font-size: 9px">
                        <td style="font-size: 9px;width: 50px;overflow: hidden; text-overflow: ellipsis;" width="80px"> 
                            <a href=""  onClick="return getExistingCustValue('<%= Customer_ID %>')" style="font-size:9px;color: #666666; text-decoration: none;" >
                        ...
                        <td   style="font-size: 9px">
                            <a href="" onClick="return getExistingCustValue('<%= Customer_ID %>')" style="font-size:9px;color: #666666; text-decoration: none;word-wrap: break-word;">  
