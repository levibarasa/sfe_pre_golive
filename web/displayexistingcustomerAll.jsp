    ...
    <header>
        ...
        <script type="text/javascript">
            ...
            function getExistingCustValue(id) {
                var rmCode = document.getElementById("rmCode").value;
                popup = window.open("addExistingAll.jsp?custId=" + id + "&rmCode=" + rmCode, "Customer Information", "width=1000,height=800");
                popup.focus();
                return false
            }
        ...
        System.out.println("CustId:: "+custId);
         String rmCode = request.getParameter("rmCode");
            ...
            if(custId == "" || custId == null ){
             ar = Customer.populateCustomerListAll(custName);
            }
            else
            if(custName == "" || custName == null){
            ar = Customer.populateCustomerListAllById(custId);
                }
                else {
            ar = new ArrayList();
                }
