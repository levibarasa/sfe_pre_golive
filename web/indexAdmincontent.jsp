    ...
    <table width="100%">
        <tr width="100%">
            <td width="20%"><br/>
                ...
                <p> <input type="submit" name="adminaccess" value="Admin Access"  onclick="window.location = 'indexAdminusermgr.jsp'" width="100%" id="adminaccess"   style="color:#ffffff;background-color:#24315e"></p>
            ...
            <td width="20%">
                ...
                <p> <input type="button" name="remindersfortoday" value="Reminders For Today" width="100%" id="remindersfortoday"   style="border-radius: 12px; border-radius: 12px; color:#ffffff;background-color:#24315e"></p>
                <br/><br/><br/><br/><br/> 
                <Strong>  
