...
<html>
    ...
    <body>
        <h2 style="font: bold 90% 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size: 16px">Loan disbursement/ demands</h2>
        <form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=doloan" onsubmit=" return validatePasswords(this)">
            <table width="100%" border="0" align="left" cellpadding="5" cellspacing="1">
                <tr>
                    <th colspan="8" align="left" scope="col"><div class="header">&nbsp;Loan Disbursement/ Demands</div></th>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td></td>
                    <td><label>
                            <input name="Submit" class="redButton" type="submit" onclick="MM_validateForm('group', '', 'R', 'fromdate', '', 'R', 'subgroup', '', 'R',
                                            'todate', '', 'R');
