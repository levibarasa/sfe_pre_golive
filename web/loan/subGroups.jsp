...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            function getSubGroupCodeValue(ths, sGroupName) {
                if (window.opener !== null && !window.opener.closed) {
                    var func = window.opener.document.getElementById("subgroup");
                    var sgrpn = window.opener.document.getElementById("subgroupName");
    ...
    <form id="popup">
        <table width="95%" align="center"  style="border:#013567 solid 2px;padding:10px;" border="0">
            ...
            <tr style="height:30px; padding:4px;">
                <td><div align="center"><a href="" onclick="getSubGroupCodeValue(this, '<%=(String) one.get(2)%>')" id="cname"><%=(String) one.get(0)%></a></div></td>
