    ...
    <head>
        ...
        <script type="text/javascript">
            function getGroupValue(ths, grpname, solid, brname, grmgr, regno, fordat,
                    ...
                    alwdm, alwdgs,grpchairid, grpchair,grptreid, grptre,grpsecid, grpsec,
                    gpstat, gpstatcd, nomem, mefreq,  saac, saacbal, lac, lacbal) {
        ...
        <table width="95%" align="center"  style="border:#013567 solid 2px;padding:10px;" border="0">
            ...
            <tr style="height:30px; padding:4px;">
                <td><div align="center"><a href="" onclick="getGroupValue(this, '<%=(String) one.get(2)%>', '<%=(String) one.get(5)%>',
                                ...
                                '<%=(String) one.get(18)%>',  '<%=(String) one.get(19)%>', '<%=(String) one.get(20)%>', '<%=(String) one.get(32)%>',
                                 '<%=(String) one.get(21)%>','<%=(String) one.get(33)%>','<%=(String) one.get(22)%>','<%=(String) one.get(34)%>',
                                 '<%=(String) one.get(23)%>', '<%=(String) one.get(24)%>', '<%=(String) one.get(25)%>',
