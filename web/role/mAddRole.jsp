<%
    String roleAct = (String) session.getAttribute("roleAct");
%>
<head>
...
<form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=domrole" onsubmit=" return validatePasswords(this)">
    <table width="70%" border="0" align="center" cellpadding="5" cellspacing="2">
        <tr>
            <th colspan="5" scope="col"><div class="header">&nbsp;Add new role</div></th>
        </tr>
        <tr>
            <td width="20%">&nbsp;</td>
            <td width="27%">&nbsp;</td>
        ...
        <tr>
            ...
            <td><label>
                    <input name="function" type="text" readonly="true" id="function" onkeyup="caps(this)" class="textboxes" value="<%=roleAct%>"/>
                </label></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td style="color: red">*</td>
            <td><label>
                    <input name="rolename"  type="text" id="rolename" onkeyup="this.value = this.value.toUpperCase();" class="textboxes" maxlength="6"/>
                </label></td>
            <td></td>
        </tr>
        <tr>
