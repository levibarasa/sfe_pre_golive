<head>
    ...
    <script type="text/javascript">
        ...
        function getGroupCodeValue() {
            popup = window.open("loan/gGroups.jsp", "Functions", "width=500,height=400, resizable=false");
            popup.focus();
            return false;
        }
    </script>
...
<form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=gorpt" onsubmit=" return validatePasswords(this)">
    <table width="90%" border="0" align="left" cellpadding="5" cellspacing="2">
        ...
        <tr>
            <td>Group code</td>
            <td>:</td>
            <td><input type="text" name="groupcode" onkeyup="this.value = this.value.toUpperCase();" value="" id="groupcode" readonly="true" /></td>
            <td><a href="" onclick="return getGroupCodeValue()"/><img src="images/search.png"/></a></td>
            <td>Group Name</td>
            <td>:</td>
            <td colspan="2"><input type="text" name="groupName" onkeyup="this.value = this.value.toUpperCase();" value="" id="groupName" readonly="true" /></td>
