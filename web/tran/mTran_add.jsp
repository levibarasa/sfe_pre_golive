    ...
    <body>
        ...
        <form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=doaddtran" onsubmit=" return validatePasswords(this)">
            <table width="100%" border="0" align="left" cellpadding="5" cellspacing="1">
                <tr>
                    <th colspan="8" align="left" scope="col"><div class="header">&nbsp;Transaction Maintenance</div></th>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td><label>
                            <input name="Submit" class="redButton" type="submit" onclick="MM_validateForm('subgroup', '', 'R', 'subgroupName', '', 'R');
