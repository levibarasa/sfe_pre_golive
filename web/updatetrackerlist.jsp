...
<html>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="jsDatePick_ltr.min.css" />
       ...
       <script type="text/javascript">
        ...
        function getCustUpdateDValue(id) {
                var rmCode = document.getElementById("rmCode").value;
...
//          /
            function doupdpostDriver() {
                var custId = document.getElementById("custId").value;
                 var rmCode = document.getElementById("rmCode").value;
                var todayproduct  = document.getElementById("todayproduct").value; 
                var scheduledcalldate = document.getElementById("scheduledcalldate").value;
         window.location.href = 'dailyupdatelist.jsp?custId=' + custId +'&rmCode=' +rmCode +'&todayproduct=' +todayproduct +'&scheduledcalldate=' +scheduledcalldate;       
    ...
    <body>
        ...
        <input type="button" onClick="return getMarketedProductValue('<%= custId%>');"  name="newproduct" value="Add Product to Market/Sell" width="100%" id="newproduct"   style="color:#ffffff;background-color:#24315e;align-self: center;width: 30em;border-right: 50px;  height: 2em; border-radius: 12px;">
