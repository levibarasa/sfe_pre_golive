...
<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*,
         java.util.*,com.orig.gls.dao.admin.user.User" errorPage="" %>
<%
    User frd = new User();
...
<form method="post">
    ...
    <table width="95%" align="center"  style="border:#019ADD solid 2px;padding:10px;" border="1">
        ...
        <tr style="height:30px; padding:4px;">
            ...
            <td>
                <input value="Verify" type="button" class="redButton" onclick="javascript:deleteDriver(<%=(String) one.get(2)%>)" size="6"/>
            </td>
        </tr>
        <% }%>
    </table>
